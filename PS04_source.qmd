...
-   The relationship in @fig-TSG appears to be positive. This relationship seems to be reasonably linear.
:::
...
-   No, this will not cause an increase in Trump support. The main reason for this is that correlation, or association, does not mean causation. Just because two variable are correlated does not mean they cause increases and decreases in each other. On top of this, the correlation coefficient for `poverty` and `trump_support` is not a very strong one.
:::
...
-   Using this prediction model, we can expect Trump support around 43.16%.
:::
...
-   No, it would not be a good idea to use this regression equation to predict Trump support at 85% white poverty. This is because by using the equation we get a percentage over 200%, which doesn't make any sense.
:::
...
-   I expect that the correlation coefficient is going to be negative because the slope of the line of best fit is negative.
...
-   The intercept means when the percentage of nonwhite households in the area is zero, you can predict a 53.328% Trump support rate.

-   The slope estimates that the percentage of Trump support in an area drops by a value of 0.269% percent when the percentage of nonwhite households increases by 1%.
:::
...
-   The mathematical prediction shows that if 70% of an area's population was nonwhite, the expected Trump support in that region would be around 39.5%.
:::
...
-   The explanatory variable `poverty` seems to be a better explanatory variable of Trump support. This is because its correlation coefficient is larger, which generally means it will have smaller residuals.
:::
...
**A.** Her prediction of Trump support in that region would be around 41.9%.
